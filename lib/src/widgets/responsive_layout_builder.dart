  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= SampleEcommerceAppBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= SampleEcommerceAppBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= SampleEcommerceAppBreakpoints.large) {
